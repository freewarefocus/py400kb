...
4. **Pure Python implementation** - No need for cmake or compilation & no Python libraries need to be addedShould support all pi4 and pi5 models, although you will nee```d to pass in the exact settings for your keyboard & mouse (using the keyboard/mouse VID, PID and DEV command line options)
